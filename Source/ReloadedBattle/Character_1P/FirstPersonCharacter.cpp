...
void AFirstPersonCharacter::BeginPlay()
{
	...
	else {UE_LOG(LogTemp, Warning, TEXT("No Gun Blueprint attached to Player!")) }
	...
	InputComponent->BindAction("Fire", IE_Pressed, SpawnGun, &AGun::OnFire);
}
...
void AFirstPersonCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	//PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AFirstPersonCharacter::FireMethod);
